...
function f3(){
   ...
   else if(+input32.value> +input31.value){
...
function f7(){
   out7.innerHTML = Math.pow(+input71.value, +input72.value);
}
...
function f8(){
   switch(+select8.value){
      case 1: out8.innerHTML = 'one'; break;
      case 2: out8.innerHTML = 'two'; break;
      case 3: out8.innerHTML = 'three'; break;
      default: out8.innerHTML = 'Don`t get if :-}';
   }
}
...
function f13(){
   let val13 = input130.value;
   out13.innerHTML = typeof(val13);
}
...
function f14(){
   switch(select143.value){
      case '+':out14.innerHTML = +input141.value + +input142.value; break;
      case '-':out14.innerHTML = +input141.value - +input142.value; break;
      case '*':out14.innerHTML = +input141.value * +input142.value; break;
      case '/':out14.innerHTML = +input141.value / +input142.value; break;
      default: console.log('default string');
   }
}
...
function f15(){
   switch(select153.value){
      case "&&" : if(select151.value==0 && select152.value==0){ out15.innerHTML = 1; }
      case "&&" : if(select151.value==1 && select152.value==1){ out15.innerHTML = 1; }
      case "&&" : if(select151.value==0 && select152.value==1){ out15.innerHTML = 0; }
      case "&&" : if(select151.value==1 && select152.value==0){ out15.innerHTML = 0; }
      case "||" : if(select151.value==0 && select152.value==1){ out15.innerHTML = 1; }
      case "||" : if(select151.value==0 && select152.value==1){ out15.innerHTML = 1; }
      

      break;
      default: console.log('Dynamic theatre');
   }
}
