...
let c =  7;
let d = 9;
let out2 = document.querySelector('.out-2').textContent = c/d;
...
let but8 = document.querySelector('.b-8').onclick = function t8() {
    // value всегда получаем внутри функции
    let data = document.querySelector('.i-8').value; // получили значение
    // тут выводим
    let out8 = document.querySelector('.out-8').innerHTML = data;
}
...
function t9() {
    let data1 = document.querySelector('.i-9').value; // получили значение
    // тут выводим
    let out9 = document.querySelector('.out-9').innerHTML = data1;
    data1.value = '';
}
...
function t10() {
    ...
    let out10 = document.querySelector('.out-10').innerHTML = inp/20;
}
...
function t11() {
    let inp1 = document.querySelector('.i-11').value;
    let out11 = document.querySelector('.out-11').innerHTML = inp1+55;
}
...
function t12() {
    ...
    let nameoutput = document.querySelector('.out-12').innerHTML = `Hello, ${name} ${surname}`;
...
function t13() {
    let a_1 = document.querySelector('.i-13-1').value;
    let b_1 = document.querySelector('.i-13-2').value;
    let nameoutput = document.querySelector('.out-13').innerHTML = +a_1 + +b_1;
}
...
function t14() {
    let out14 = document.querySelector('.i-14').value = 'Go';
}
...
function t15() {
    let out15 = document.querySelector('.i-15').innerHTML = `${style.border = "4px solid red"}`;
}
...
function t16() {
    let input16_1 = document.querySelector('.i-16-1').value;
    let input16_2 = document.querySelector('.i-16-2').value;
    let out16 = document.querySelector('.out-16').innerHTML = input16_1 + input16_2;
}
...
function t18() {
    ...
    let out18 = document.querySelector('.out-18').innerHTML = parseFloat(inp18);
}
...
function t19() {
    let input19_1 = document.querySelector('.i-19-1').value;
    let input19_2 = document.querySelector('.i-19-2').value;
 let out19 = document.querySelector('.out-19').innerHTML = +input19_1 + +input19_2;
...
function t20() {
    ...
    let out20 = document.querySelector('.out-20').innerHTML = count;
}
